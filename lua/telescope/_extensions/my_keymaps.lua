      ...
      pickers.new(opts, {
        ...
        finder = finders.new_table {
          results = {
            ...
            { "[n] <Plug>(comment_toggle_blockwise_count) (Comment.nvim)", "", "Comment toggle blockwise with count" },
            { "[n] <Plug>(comment_toggle_linewise_count) (Comment.nvim)", "", "Comment toggle linewise with count" },
            { "[n] <Plug>(comment_toggle_blockwise_current) (Comment.nvim)", "", "Comment toggle current block" },
            { "[n] <Plug>(comment_toggle_linewise_current) (Comment.nvim)", "", "Comment toggle current line" },
            ...
            { "[n] <M-l>", ":bprevious<CR>", "Previous buffer" },
            { "[n] <M-h>", ":bnext<CR>", "Next buffer" },
            ...
            { "[v] gb (Comment.nvim)", "<Plug>(comment_toggle_blockwise_visual)", "Comment toggle blockwise (visual)" },
            { "[v] gra (LSP)", "", "vim.lsp.buf.code_action()" },
            { "[v] gc (Comment.nvim)", "<Plug>(comment_toggle_linewise_visual)", "Comment toggle linewise (visual)" },
            { "[v] gx", "", "Opens filepath or URI under cursor with the system handler (file explorer, web browser, …)" },
            { "[v] <Plug>(comment_toggle_blockwise_visual) (Comment.nvim)", "<Esc><Cmd>lua require(\"Comment.api\").locked(\"toggle.blockwise\")(vim.fn.visualmode())<CR>", "Comment toggle blockwise (visual)" },
            { "[v] <Plug>(comment_toggle_linewise_visual) (Comment.nvim)", "<Esc><Cmd>lua require(\"Comment.api\").locked(\"toggle.linewise\")(vim.fn.visualmode())<CR>", "Comment toggle linewise (visual)" },
            ...
            { "[x] gb (Comment.nvim)", "<Plug>(comment_toggle_blockwise_visual)", "Comment toggle blockwise (visual)" },
            { "[x] gra (LSP)", "", "vim.lsp.buf.code_action()" },
            { "[x] gc (Comment.nvim)", "<Plug>(comment_toggle_linewise_visual)", "Comment toggle linewise (visual)" },
            { "[x] gx", "", "Opens filepath or URI under cursor with the system handler (file explorer, web browser, …)" },
            { "[x] <Plug>(comment_toggle_blockwise_visual) (Comment.nvim)", "<Esc><Cmd>lua require(\"Comment.api\").locked(\"toggle.blockwise\")(vim.fn.visualmode())<CR>", "Comment toggle blockwise (visual)" },
            { "[x] <Plug>(comment_toggle_linewise_visual) (Comment.nvim)", "<Esc><Cmd>lua require(\"Comment.api\").locked(\"toggle.linewise\")(vim.fn.visualmode())<CR>", "Comment toggle linewise (visual)" },
          },
